...
describe('getCredentials', () => {
  it('should load default credentials from file', async () => {
    const credentials = await getCredentials(testCredentialsFile);
  ...
  it('should return undefined if incorrect profile used', async () => {
    const credentials = await getCredentials(testCredentialsFile, 'bad');
